...
<h1 class="text-3xl font-bold mb-1 text-emerald-600 flex gap-2 items-center">
  <i>
...
<div class="w-full flex flex-col md:flex-row gap-2">
  <div class="bg-neutral-900/75 rounded-xl py-3 px-6 shadow-lg md:w-1/3 w-full">
    <div class="flex justify-between items-start gap-2">
      <div class="flex flex-col">
        ...
        <h3 class="text-xl font-semibold text-white mt-2">Lenovo Workstation 332</h3>
        <div>
          <a href="/" class="font-medium hover:underline">192.168.2.1</a>
          <span>&#183;</span>
          <a href="/" class="font-medium hover:underline">Room ITA-7</a>
        </div>
      </div>
